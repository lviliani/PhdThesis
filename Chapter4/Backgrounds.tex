...
The signal extraction procedure requires the determination of the normalization and (\mll, \mt)
...
\caption{Comparison between the \mll shape obtained with the default $\mathrm{q\bar{q}'\to W^{+}W^{-}}$ background simulation (\textsc{Madgraph}) and other theoretical models in every \pth bin.\label{fig:ww_mll}}
\end{figure}
...
\caption{Comparison between the \mt shape obtained with the default $\mathrm{q\bar{q}'\to W^{+}W^{-}}$ background simulation (\textsc{Madgraph}) and other theoretical models in every \pth bin.\label{fig:ww_mth}}
\end{figure}

The gluon-induced WW process, i.e. $\mathrm{gg\to W^{+}W^{-}}$, has a subdominant contribution with respect to the quark-induced process, being the cross section ratio between the two of about 5\%. The \mll and \mt shapes for this background are taken from simulation while the cross section is scaled to the approximate NLO calculation~\cite{Bonvini:2013jha,Passarino:2013bha}.
...
Since the $CR_{\ttbar}$ control region and the signal region ($SR$) are orthogonal, a factor $\alpha$ connecting the number of events in the two is evaluated in simulation using the following formula:
...
\begin{figure}[htb]
\centering
\subfigure[$\pth<15\GeV$]{\includegraphics[width=0.31\textwidth]{images/mllBin0CtrlDD-v2.pdf}}
\subfigure[$15\GeV<\pth<45\GeV$]{\includegraphics[width=0.31\textwidth]{images/mllBin1CtrlDD-v2.pdf}}
\subfigure[$45\GeV<\pth<85\GeV$]{\includegraphics[width=0.31\textwidth]{images/mllBin2CtrlDD-v2.pdf}}\\
\subfigure[$85\GeV<\pth<125\GeV$]{\includegraphics[width=0.31\textwidth]{images/mllBin3CtrlDD-v2.pdf}}
\subfigure[$125\GeV<\pth<165\GeV$]{\includegraphics[width=0.31\textwidth]{images/mllBin4CtrlDD-v2.pdf}}
\subfigure[$\pth>165\GeV$]{\includegraphics[width=0.31\textwidth]{images/mllBin5CtrlDD-v2.pdf}}
...
In the 0 jets category the residual top quark background is very small, and its normalization is estimated inclusively in \pth. In this category the factor defined in Eq.\eqref{eq:alpha} is found to be $\alpha = 0.60 \pm 0.06$.
...
This method permits to avoid the simulation of very large MC samples that would be needed for an accurate description of this process, given its large cross section. 
