...
\footnotesize{
  ...
  W$\gamma^{*}$, W$\gamma$  & $30\%$ \\
  \toprule
  \multicolumn{2}{c} {\bf{Effect of the experimental uncertainties in the signal and background yields}}\\
  \midrule
  Source & Uncertainty\\
  \midrule
  ...
  \toprule
  \multicolumn{2}{c}{\bf{Effect of the theoretical uncertainties in the signal yield}}\\
  \midrule
  Source & Uncertainty \\
  \midrule
...
%-------------------------------------------------------------------------------
\subsection{Uncertainties in background predictions}
%-------------------------------------------------------------------------------
...
%The effect on the signal strengths is found to be of the order of 1\%.
...
these backgrounds are expected to give a small contribution in the signal phase space. Uncertainties in the cross sections reported in~\cite{bib:ellis} are 4\% for WZ and 2.5\% for ZZ. A 30\% uncertainty is assigned to the W$\gamma$~\cite{WgammaXsec} and W$\gamma^{*}$ yields, according to the uncertainty in the normalization study (see Sec.~\ref{sec:diboson}).
...
%-------------------------------------------------------------------------------
\subsection{Statistical uncertainty of the simulated samples}
%-------------------------------------------------------------------------------
