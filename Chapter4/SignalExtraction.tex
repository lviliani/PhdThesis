...
The fit makes use of the binned maximum likelihood approach.The likelihood function, $\mathcal{L}$, restricted to a given \pth bin $j$, can be written as: \textcolor{red}{CHECK!!}
