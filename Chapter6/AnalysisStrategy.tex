...
\includegraphics[width=0.4\textwidth]{images/13TeV/Interference/0j_300.eps}
}
\subfigure[$M_\mathrm{X}=700$\GeV - 0 jets]{
\includegraphics[width=0.4\textwidth]{images/13TeV/Interference/0j_700.eps}
}\\

\subfigure[$M_\mathrm{X}=300$\GeV - 1 jet]{
\includegraphics[width=0.4\textwidth]{images/13TeV/Interference/1j_300.eps}
}
\subfigure[$M_\mathrm{X}=700$\GeV - 1 jet]{
\includegraphics[width=0.4\textwidth]{images/13TeV/Interference/1j_700.eps}
}\\

\subfigure[$M_\mathrm{X}=300$\GeV - VBF]{
\includegraphics[width=0.4\textwidth]{images/13TeV/Interference/VBF_300.eps}
}
\subfigure[$M_\mathrm{X}=700$\GeV - VBF]{
\includegraphics[width=0.4\textwidth]{images/13TeV/Interference/VBF_700.eps}
}\\
\caption{
