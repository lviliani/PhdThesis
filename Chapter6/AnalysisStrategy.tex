...
\includegraphics[width=0.3\textwidth]{images/13TeV/Interference/0j_300.eps}
}
\subfigure[$M_\mathrm{X}=300$\GeV - 1 jet]{
\includegraphics[width=0.3\textwidth]{images/13TeV/Interference/1j_300.eps}
}
\subfigure[$M_\mathrm{X}=300$\GeV - VBF]{
\includegraphics[width=0.3\textwidth]{images/13TeV/Interference/VBF_300.eps}
}\\
\subfigure[$M_\mathrm{X}=700$\GeV - 0 jets]{
\includegraphics[width=0.3\textwidth]{images/13TeV/Interference/0j_700.eps}
}
\subfigure[$M_\mathrm{X}=700$\GeV - 1 jet]{
\includegraphics[width=0.3\textwidth]{images/13TeV/Interference/1j_700.eps}
}
\subfigure[$M_\mathrm{X}=700$\GeV - VBF]{
\includegraphics[width=0.3\textwidth]{images/13TeV/Interference/VBF_700.eps}
}

\caption{
    Distributions of the \mti variable for $M_\mathrm{X}=$300 and 700\GeV, showing the signal (both the ggH and VBF processes) and the interference contributions in the three jet categories.}
    \label{fig:mti_int}
\end{figure}
