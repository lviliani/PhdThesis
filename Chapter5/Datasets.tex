...
The cross sections of the different single top processes are estimated by the LHC Top Working group~\cite{Aliev:2010zk} with NLO accuracy.
The \ttbar cross section is also provided by the LHC Top Working group~\cite{Beneke:2011mq}, and is computed at NNLO QCD accuracy and NNLL accuracy for soft gluon resummation effects.
